...
/**
 * Displays a picture and lets you explore the picture by displaying the row, column, red, green,
 * and blue values of the pixel at the cursor when you click a mouse button or press and hold a
 * mouse button while moving the cursor. It also lets you zoom in or out. You can also type in a row
 * and column value to see the color at that location.
 * 
 * Originally created for the Jython Environment for Students (JES). Modified to work with DrJava by
...
public class PictureExplorer implements MouseMotionListener, ActionListener, MouseListener
{
	...
	/**
	 * Method to check that the current position is in the viewing area and if not scroll to center the
	...
	/**
	 * Method to display the pixel information from the passed x and y but also converts x and y from
	 * strings
	 * 
	 * @param xString
