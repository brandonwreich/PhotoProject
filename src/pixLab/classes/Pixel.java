...
public class Pixel
{
	...
	/**
	 * A constructor that takes the x and y location for the pixel and the picture the pixel is coming
	 * from
	 * 
	 * @param picture
	...
	public int getAlpha()
	{
		...
		/*
		 * get the value at the location from the picture as a 32 bit int with alpha, red, green, blue each
		 * taking 8 bits from left to right
		 */
	...
	/**
	 * Method to get the amount of red at this pixel. It will be from 0-255 with 0 being no red and 255
	 * being as much red as you can have.
	 * 
	...
	/**
	 * Method to get the amount of green at this pixel. It will be from 0-255 with 0 being no green and
	 * 255 being as much green as you can have.
	 * 
	...
	/**
	 * Method to get the amount of blue at this pixel. It will be from 0-255 with 0 being no blue and
	 * 255 being as much blue as you can have.
	 * 
