...
/**
 * A class that represents a simple picture. A simple picture may have an associated file name and a
 * title. A simple picture has pixels, width, and height. A simple picture uses a BufferedImage to
 * hold the pixels. You can show a simple picture in a PictureFrame (a JFrame). You can also explore
 * a simple picture.
 * 
...
public class SimplePicture implements DigitalPicture
{
	...
	/**
	 * A Constructor that takes no arguments. It creates a picture with a width of 200 and a height of
	 * 100 that is all white. A no-argument constructor must be given in order for a class to be able to
	 * be subclassed. By default all subclasses will implicitly call this in their parent's no-argument
	 * constructor unless a different call to super() is explicitly made as the first line of code in a
	 * constructor.
	 */
	...
	/**
	 * A constructor that takes the width and height desired for a picture and creates a buffered image
	 * of that size. This constructor doesn't show the picture. The pixels will all be white.
	 * 
	 * @param width
	 *            the desired width
	 * @param height
	...
	/**
	 * A constructor that takes the width and height desired for a picture and creates a buffered image
	 * of that size. It also takes the color to use for the background of the picture.
	 * 
	 * @param width
	 *            the desired width
	 * @param height
	...
	/**
	 * Method to get a Graphics2D object for this picture which can be used to do 2D drawing on the
	 * picture
	 */
	 ...
	 * 
	 * @return a one-dimensional array of Pixel objects starting with y=0 to y=height-1 and x=0 to
	 *         x=width-1.
	 */
	...
	/**
	 * Method to load the picture from the passed file name this just calls load(fileName) and is for
	 * name compatibility
	 * 
	 * @param fileName
	 *            the file name to use to load the picture from
	...
	/**
	 * Method to create a new picture of the passed width. The aspect ratio of the width and height will
	 * stay the same.
	 * 
	 * @param width
	 *            the desired width
	...
	/**
	 * Method to create a new picture of the passed height. The aspect ratio of the width and height
	 * will stay the same.
	 * 
	 * @param height
	 *            the desired height
	...
	/**
	 * Method to get the coordinates of the enclosing rectangle after this transformation is applied to
	 * the current picture
	 * 
